package com.example.deukgeun.payment.repository;
...
public class PaymentRepositoryTest {
    ...
    void givenExistingApplicantId_whenFindByApplicantId_ReturnValid() {
        ...
        // When
        PaymentInfo result = paymentInfoRepository.findByApplicantIdAndDeleteDateIsNull(applicantId).orElse(null);
    ...
    public void givenNonExistingApplicantId_whenFindByApplicantId_ReturnValid() {
        ...
        // When
        PaymentInfo optionalPaymentInfo = paymentInfoRepository.findByApplicantIdAndDeleteDateIsNull(applicantId).orElse(null);
