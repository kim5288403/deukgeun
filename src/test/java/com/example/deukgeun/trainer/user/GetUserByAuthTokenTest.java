...
@SpringBootTest
@Transactional
public class GetUserByAuthTokenTest {
    @Autowired
    ...
    @Test
    void shouldGetUserByAuthTokenForValidParameter() {
        // Given
        ...
        // When
        User result = userService.getUserByAuthToken(jwt);
    ...
    @Test
    void shouldSignatureExceptionForValidParameter() {
        // Given
        String email = "testEmail@test.com";
        ...
        assertThrows(SignatureException.class, () -> {
            userService.getUserByAuthToken(jwt);
        });
    }
