package com.example.deukgeun.auth.service.application;
...
import com.example.deukgeun.auth.domain.service.implement.AuthMailDomainServiceImpl;
...
public class AuthMailApplicationServiceTest {
    ...
    void givenEmailAndCode_whenSave_thenInvokeSaveMethod() {
        ...
        // When
        mockAuthMailApplicationService.save(toEmail, authCode);
