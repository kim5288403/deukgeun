...
public interface PaymentMapper {
    ...
    @Named("toPaymentInfo")
    @Mapping(source = "paymentCancelInfoEntity", target = "paymentCancelInfo", qualifiedByName = "toPaymentCancelInfo")
    PaymentInfo toPaymentInfo(PaymentInfoEntity paymentInfoEntity);

    @Named("toPaymentInfoEntity")
    @Mapping(source = "paymentCancelInfo", target = "paymentCancelInfoEntity", qualifiedByName = "toPaymentCancelInfoEntity")
